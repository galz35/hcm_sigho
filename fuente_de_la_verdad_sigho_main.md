...
```css
@import url('https://cdn.jsdelivr.net/gh/galz35/hcm_sigho@e0c1344/pdf_pages/pagina1_sigho_main_copia/css/master_bundle.css');
```

> **Nota**: `master_bundle.css` importa internamente los módulos de `base`, `header`, `hero`, `buscador`, `highlights`, `benefits`, `video`, `process`, `cta`, `footer`, `font-claro`, `nuestra_esencia.css` y `claro_pais.css`.
